...
COORD_MAP = {
    ...
    "JULIANA MIRELLA ALVES RODRIGUES": [
        "ARTHUR MASSARI", "DANIEL BARROS DE OLIVEIRA", "KELIANE DE OLIVEIRA",
        "MATHEUS CAVALCANTI DE ARAUJO", "MONIQUE DE KAROLIN SILVA DA COSTA", "NATALIA PAIVA DE PAULA",
    ...
    "SUZANA MARIA CAMPOS MARANHÃO DE LIMA": [
        "GIOVANNA CAMPOS PEREIRA", "GUSTAVO LOPES ALENCAR FILHO",
