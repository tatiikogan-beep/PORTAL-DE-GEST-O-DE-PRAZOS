...
COORD_MAP = {
    "ARMANDO HÉLIO ALMEIDA MONTEIRO DE MORAES": ["MARCELLE LEITE RENTROIA"],
    ...
    "JENIFFER ROSA BARBOSA DE SALES": ["GABRIEL BERTACCO HADDAD"],
    ...
    "RONALD FEITOSA AGUIAR FILHO": ["RONALD FEITOSA AGUIAR FILHO", "JENIFFER ROSA BARBOSA DE SALES"],
    "SUZANA MARIA CAMPOS MARANHÃO DE LIMA": [
        "GIOVANNA CAMPOS PEREIRA", "MATHEUS CAVALCANTI DE ARAUJO", "TATIANE CARMO SANTA ROSA",
